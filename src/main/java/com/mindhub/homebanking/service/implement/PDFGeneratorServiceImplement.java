...
public class PDFGeneratorServiceImplement implements PDFGeneratorService {
    ...
    public void export(HttpServletResponse response, List<Transaction> transactions, Account account, String start, String end) throws IOException {
        ...
        //Logo
        Image img = Image.getInstance("src/main/resources/static/web/Assets/Imagenes/logo.png");
        ...
        try{
            for (int i = transactions.size() - 1; i >= 0; i--){
                ...
                PdfPCell pdfPCell6 = new PdfPCell(new Paragraph(transactions.get(i).getCreationDate().format(DateTimeFormatter.ofPattern("dd-MM-yyyy")), fontBody));
